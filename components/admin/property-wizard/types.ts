...
export interface PropertyFormData {
  ...
  // Lease template (set during wizard, used to assign defaultLeaseDocumentId on property)
  leaseDocumentId?: string;

  // Review step — whether to publish to public listings immediately on save
