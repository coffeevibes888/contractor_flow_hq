...
import OwnerStatementsClient from './owner-statements-client';
...
const OwnerStatementsPage = async () => {
  await requireAdmin();
  ...
  if (!gate.canViewLedger) {
    return <AccountingUpsellPage feature='owner-statements' currentTier={gate.tier} />;
  }

  return <OwnerStatementsClient landlordId={landlord.id} />;
};
