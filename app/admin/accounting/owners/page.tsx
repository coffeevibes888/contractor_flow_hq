...
const OwnersPage = async () => {
    ...
    return (
      <main className='w-full px-4 py-10'>
        <div className='max-w-lg mx-auto text-center space-y-4'>
          ...
          <p className='text-gray-500 text-sm'>Your role does not have permission to view owner information.</p>
        </div>
      </main>
    );
  }
  ...
  if (!gate.canViewLedger) {
    return <AccountingUpsellPage feature='owners' currentTier={gate.tier} />;
  }

  return <OwnersClient landlordId={landlord.id} />;
};
